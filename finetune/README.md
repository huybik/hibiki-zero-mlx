...
post-source, contrastive, anti-repetition, and six-epoch modes are obsolete.

Core files:

- `h100.sh`: pinned H100 setup, cache build, preflight, smoke, train, and resume.
- `train.py`: five-epoch full-model training and exact recovery checkpoints.
...
- `hf_sync.py`: two-pair recovery plus promoted-best upload under
  `grounded_v2_full_direct_voice_5epoch`.
